...
- `ormgen.GenerateSpec`、`ormgen.PackageModel`、`ormgen.EntityModel`、`ormgen.MapperModel`、`ormgen.StatementModel`、`ormgen.SchemaIntrospector`、`ormgen.SQLSchemaIntrospector`、`ormgen.SQLSchemaDialect`、`ormgen.TemplateRenderer`、`ormgen.ReverseEngineerWithRenderer` 和 `goark-orm generate orm` 主命令。
