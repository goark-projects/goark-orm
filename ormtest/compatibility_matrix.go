...
func compatibilityDDL(dbType orm.DbType, quotedTable string, quotedKeyTable string, quotedCallRoutine string) ([]string, []string, error) {
	profileColumn, err := compatibilityProfileColumnDDL(dbType)
	if err != nil {
		return nil, nil, err
	}
	switch dbType {
	case orm.DbTypePostgres:
		return []string{
			...
			"CREATE TABLE " + quotedTable + " (id BIGINT PRIMARY KEY, name VARCHAR(64) NOT NULL, age INTEGER NOT NULL, " + profileColumn + ", created_at VARCHAR(40) NOT NULL)",
	...
	case orm.DbTypeMySQL, orm.DbTypeMariaDB:
		return []string{
			...
			"CREATE TABLE " + quotedTable + " (id BIGINT PRIMARY KEY, name VARCHAR(64) NOT NULL, age INTEGER NOT NULL, " + profileColumn + ", created_at VARCHAR(40) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4",
	...
	case orm.DbTypeSQLite:
		return []string{
			...
			"CREATE TABLE " + quotedTable + " (id INTEGER PRIMARY KEY, name VARCHAR(64) NOT NULL, age INTEGER NOT NULL, " + profileColumn + ", created_at VARCHAR(40) NOT NULL)",
	...
	case orm.DbTypeSQLServer:
		return []string{
			...
			"CREATE TABLE " + quotedTable + " (id BIGINT PRIMARY KEY, name NVARCHAR(64) NOT NULL, age INT NOT NULL, " + profileColumn + ", created_at NVARCHAR(40) NOT NULL)",
	...
	case orm.DbTypeOracle:
		return []string{
			...
			"CREATE TABLE " + quotedTable + " (id NUMBER(19) PRIMARY KEY, name VARCHAR2(64 CHAR) NOT NULL, age NUMBER(10) NOT NULL, " + profileColumn + ", created_at VARCHAR2(40 CHAR) NOT NULL)",
...
func compatibilityCases(namespace string, table string, quotedTable string, keyTable string, callSQL string) []DatabaseCase {
	...
	cases = append(cases,
		...
		compatibilityJSONNativeCase(quotedTable),
