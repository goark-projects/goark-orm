...
func writeResultAssociations(builder *bytes.Buffer, associations []orm.ResultAssociationMeta) {
	...
	for _, association := range associations {
		...
		writeStringField(builder, "ResultSet", association.ResultSet)
		writeStringField(builder, "ForeignColumn", association.ForeignColumn)
...
func writeResultCollections(builder *bytes.Buffer, collections []orm.ResultCollectionMeta) {
	...
	for _, collection := range collections {
		...
		writeStringField(builder, "ResultSet", collection.ResultSet)
		writeStringField(builder, "ForeignColumn", collection.ForeignColumn)
