...
var tagValueTypes = map[string]tagValueKind{
	...
	"key-column":        tagValueString,
	"update":            tagValueString,
	"update-expression": tagValueString,
	"condition":         tagValueString,
	"insert-strategy":   tagValueString,
	"update-strategy":   tagValueString,
	"where-strategy":    tagValueString,
	...
	"order-by":          tagValueBool,
	"order-desc":        tagValueBool,
	"transient":         tagValueBool,
	"size":              tagValueInt,
	"numeric-scale":     tagValueInt,
	"order-priority":    tagValueInt,
}
